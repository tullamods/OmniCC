...
L.ShowCooldownModels = "Показать модели перезарядки"
...
[[Управляет отображением восстановления
моделей (когда на восстановлении, вы
увидете темную спираль на кнопке]]

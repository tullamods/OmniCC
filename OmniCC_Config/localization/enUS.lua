...
L.MaxDuration = 'Maximum Cooldown Duration'
L.MaxDurationDesc = 'How long, in seconds, a cooldown can at most be to display cooldown text. Set to zero to include cooldowns of any duration'
